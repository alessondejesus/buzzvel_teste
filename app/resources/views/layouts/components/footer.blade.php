    ...
    <div class="container">
        <div class="row">
            <div class="col-6 col-sm-4 col-lg-6">
                <div class="py-7"><img class="d-inline-block" src="{{ asset('assets/img/gallery/logo.png') }}"
                                       width="50"
                    ...
                    <ul class="list-unstyled mt-4">
                        ...
                        <li class="mb-2"><a class="text-800 fw-bold text-decoration-none" href="#!">About Us</a>
                        </li>
                ...
                <div class="p-3 py-7 p-md-7">
                  ...
                  Street, Albania, Alifornia<br/>United States of America</span></p>
                    <div class="mt-6"><a href="#!"> <img class="me-3"
                                                         ...
                                                         alt="..."/></a><a
                            href="#!"> <img class="me-3" src="{{ asset('assets/img/icons/twitter.svg') }}"
                                            alt="..."/></a><a href="#!"> <img
                                class="me-3" src="{{ asset('assets/img/icons/instagram.svg') }}" alt="..."/></a>
                    </div>
